        ...
        <div class="empty-2-2 container mx-auto d-flex align-items-center justify-content-center flex-column"
            ...
            <div class="text-center w-100">
                ...
                <p class="title-caption">
                    Halaman yang anda tuju tidak ada. Kami<br class="d-sm-block d-none"> menyarankan anda kembali ke
                    Halaman Utama.
                </p>
                <div class="d-flex justify-content-center">
                    <a href="{{ route('dashboard') }}" class="btn btn-back d-inline-flex text-white">
                        Back to Homepage
                    </a>
                </div>
            </div>
